        ...
        <div class="card card-flush">
            ...
            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="{{ route('objective.create')}}" class="btn btn-primary">@lang('dashboard.create_title', ['page_title' => __('dashboard.objective')])</a>
                    @endcan 
                    <!--end::Add customer-->
                            ...
                            <tr data-id="{{$task->id}}">
                                ...
                                <td>
                                    <div class="d-flex">
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="{{ route('tasks.show', $task->task_id) }}" class="text-gray-800 text-hover-primary fs-5 fw-bolder mb-1" data-kt-ecommerce-category-filter="category_name">{{$task->title }}</a>
                                            <!--end::Title-->
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="{{route('tasks.show', $task->task_id)}}" class="menu-link px-3">show</a>
                                        </div>
                                        @endcan 
                                        @can('objective.edit')
                                        <div class="menu-item px-3">
                                            <a href="{{route('objective.edit', $task->id)}}" class="menu-link px-3">edit</a>
                                        </div>
                                        @endcan 
                                        <!--end::Menu item-->
                                        @can('objective.destroy')
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="#" class="menu-link px-3" data-kt-ecommerce-category-filter="delete_row" data-url="{{route('objective.destroy', $task->id)}}" data-id="{{$task->id}}">delete</a>
                                        </div>
                                        @endcan 
                                        <!--end::Menu item-->
                                    </div>
